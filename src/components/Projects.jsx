...
import img2 from "../assets/fuel-management-system.webp";
      ...
      <div className="all-projects">
        ...
        <div className="project-item">
          <div className="project-info">
            ...
            <p>
              A fuel station management system built with React, Node.js, and MongoDB 
              for efficient fuel station operations and management.
            </p>
            <a
